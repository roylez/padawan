defmodule Padawan.Mattermost do
  use Agent
  ...
  def start_link(_) do
    ...
    middleware = [
      { Tesla.Middleware.BaseUrl, Application.get_env(:padawan, :mattermost)[:api_url] },
      { Tesla.Middleware.Headers, header },
      Tesla.Middleware.PathParams,
      Padawan.MapHttpResponse
    ]
    Agent.start_link(fn -> %Padawan.Mattermost{ client: Tesla.client(middleware) } end, name: __MODULE__)
  end
